...
<body>
  ...
  <form action="#" class="clearfix" method="post" style="text-align:center">
    <input type="submit" class="button__login clearfix" name="AP" value="Aggiungi Personale"/>
    <input type="submit" class="button__login clearfix" name="EP" value="Elimina Personale"/>
  </form>
<?php
